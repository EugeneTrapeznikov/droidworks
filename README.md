...
Tool-result triage for Pi: a Jev decision model hides the parts of big tool results the agent won't need, freeing up to 10% of context in long sessions with no drop in SWE-bench tasks solved.
